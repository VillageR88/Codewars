...
///Solution
//My
const calculateYears = (principal, interest, tax, desired, counter = 1) => desired == principal ? 0 : desired > (principal = (1 / interest + 1 - tax) * principal * interest) ? calculateYears(principal, interest, tax, desired, counter += 1) : counter;
